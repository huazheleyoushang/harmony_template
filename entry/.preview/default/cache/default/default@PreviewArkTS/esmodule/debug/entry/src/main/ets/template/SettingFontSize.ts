...
class SettingFontSize extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/template/SettingFontSize.ets(20:5)");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/template/SettingFontSize.ets(21:7)");
            Scroll.width('100%');
            Scroll.height('100%');
        }, Scroll);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/template/SettingFontSize.ets(22:9)");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(`当前字体大小${this.changeFontSize}`);
            Text.debugLine("entry/src/main/ets/template/SettingFontSize.ets(23:11)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Slider.debugLine("entry/src/main/ets/template/SettingFontSize.ets(27:11)");
            Slider.width('68%');
